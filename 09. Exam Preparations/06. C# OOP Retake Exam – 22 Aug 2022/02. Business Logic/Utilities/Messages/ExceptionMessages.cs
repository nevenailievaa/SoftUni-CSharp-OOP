namespace BookingApp.Utilities.Messages
{
    ...
    {
        public const string PricePerNightNegative = "Price cannot be negative!";//DONE
        ...
        public const string DurationZeroOrLess = "Duration cannot be negative or zero!";//Done

        public const string AdultsZeroOrLess = "Adults count cannot be negative or zero!";//Done
        ...
        public const string RoomTypeIncorrect = "Incorrect room type!";//Done
        ...
        public const string PriceAlreadySet = "Price is already set!";//Done
    }
}
