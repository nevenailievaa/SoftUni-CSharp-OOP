namespace PlanetWars.Utilities.Messages
{
    public static class ExceptionMessages
    {
        ...
        public const string WeaponDestructionLevelLow = "{0} destruction level cannot be less than {1} power points.";
        public const string WeaponDestructionLevelHigh = "{0} destruction level cannot exceed {1} power points.";
